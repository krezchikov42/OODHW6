...
public class TextViewTest {
  ...
  public void testText() {
    ...
    EasyShape oval = new Oval(10, 10, new Point(1, 1),
        EasyShape.PinHole.Top,
        "Oval", 1, 10, new Color(20, 30, 50));
    EasyShape rect = new Rectangle(30, 40, new Point(50, 50),
        EasyShape.PinHole.Top,
        "Rect", 10, 30, new Color(40, 40, 40));
    model.addShape(oval);
    model.addShape(rect);
    model.addAction(new MoveAction(oval, new Point(1, 1), new Point(10, 10),
        5, 8));
    model.addAction(new ColorAction(rect, new Color(20, 30, 50),
        new Color(100, 100, 100), 15, 20));
    model.addAction(new ScaleAction(rect, 30, 40, 60, 80, 17,
        25));
    ...
    assertEquals("Name: Oval\n" +
            ...
            + "to t=25.00\n",
        view.getText(model.getShapes(), model.getActions(), 1.0f, model.getEndTime()));
  }
  ...
  public void testRectangleMovesRight() {
    ...
    Assert.assertEquals("Name: R\n" +
        ...
        v.getText(m.getShapes(), m.getActions(), 1.0f, m.getEndTime()));
  ...
  public void testRectangleMovesAndChangesRedToGreen() {
    ...
    MoveAction a = new MoveAction(r, new Point(20, 20), new Point(400, 20),
        5, 20);
    m.addAction(a);

    ColorAction a2 = new ColorAction(r, new Color(1.0f, 0.0f, 0.0f),
